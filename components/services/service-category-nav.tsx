    ...
    <nav aria-label={copy.categories.title} className="flex flex-col gap-3">
      ...
      >
        {SERVICE_CATEGORY_GROUPS.map((group) => (
          ...
          >
            <AccordionTrigger className="rounded-btn px-1 py-2 text-xs font-semibold tracking-wide text-text-secondary uppercase hover:no-underline hover:text-foreground">
