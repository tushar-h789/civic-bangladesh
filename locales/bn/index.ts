...
// Typed against `Dictionary` (the English shape) so TypeScript flags any
// missing or mismatched key as soon as a new namespace/string is added to
// the English source, instead of silently falling back at runtime.
